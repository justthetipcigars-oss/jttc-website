...
export async function GET() {
  try {
    ...
    if (error) return NextResponse.json({ error: 'Failed to load ashtray' }, { status: 500 });
...
export async function POST(req: NextRequest) {
  try {
    ...
    if (error) return NextResponse.json({ error: 'Failed to save ashtray entry' }, { status: 500 });
...
export async function PATCH(req: NextRequest) {
  try {
    ...
    if (error) return NextResponse.json({ error: 'Failed to update ashtray entry' }, { status: 500 });
