        ...
        <main style={{ background: 'var(--color-pitch)', minHeight: '100vh', paddingTop: '116px' }}>
          <div className="max-w-md mx-auto px-6 py-20 text-center">
            <div style={{ background: 'var(--color-charcoal)', border: '1px solid var(--color-charcoal-mid)', padding: '3rem 2rem' }}>
              ...
              <h2 className="display" style={{ fontSize: '1.5rem', fontWeight: 600, color: 'var(--color-cream)', marginBottom: '1rem' }}>
                Check your email
              </h2>
              <p style={{ color: 'var(--color-smoke)', lineHeight: 1.7, fontSize: '0.9rem' }}>
                We sent a confirmation link to <strong style={{ color: 'var(--color-cream)' }}>{email}</strong>. Click it to activate your account.
              </p>
            </div>
          </div>
        </main>
      ...
      <main style={{ background: 'var(--color-pitch)', minHeight: '100vh', paddingTop: '116px' }}>
        <div className="max-w-md mx-auto px-6 py-20">
            ...
            <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <div>
                ...
                <input
                  ...
                  required
                  style={{ width: '100%', padding: '0.75rem 1rem', background: 'var(--color-pitch)', border: '1px solid var(--color-charcoal-mid)', color: 'var(--color-cream)', fontSize: '0.9rem', outline: 'none', boxSizing: 'border-box' }}
                />
              </div>
              <div>
                <label style={{ color: 'var(--color-smoke)', fontSize: '0.75rem', letterSpacing: '0.1em', textTransform: 'uppercase', display: 'block', marginBottom: '0.5rem' }}>
          ...
          <div style={{ textAlign: 'center', marginTop: '1.5rem' }}>
            <Link href="/account/login" style={{ color: 'var(--color-smoke)', fontSize: '0.875rem' }}>
              Already have an account? <span style={{ color: 'var(--color-terracotta)' }}>Sign in</span>
            </Link>
          </div>
